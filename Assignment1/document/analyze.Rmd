...
final_df <- readRDS("../data/cleaned/num_student_truancy_data.rds")
```
...
```{r figure1, fig.width=8, fig.height=5, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r figure2, fig.width=8, fig.height=5, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r figure3, fig.width=8, fig.height=5, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r figure4, fig.width=8, fig.height=5, echo=FALSE, warning=FALSE, message=FALSE}
df_2022 <- yearly_pref %>%
    filter(year == 2022)
...
```{r figure5, fig.width=10, fig.height=7, echo=FALSE, warning=FALSE, message=FALSE}
#df_2022_hl <- df_2022 %>%
